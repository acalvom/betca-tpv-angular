...
export class UserService {
  ...
  private users: User[] = [
    {mobile: 1234324, name: 'Hector', role: Role.CUSTOMER},
    {mobile: 1236453, name: 'Mario', role: Role.ADMIN},
    {mobile: 1264563, name: 'Pablo', role: Role.MANAGER},
    {mobile: 1346623, name: 'Rafa', role: Role.CUSTOMER},
    {mobile: 1256773, name: 'Jaime', role: Role.OPERATOR},
  ];
